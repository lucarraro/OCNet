...
* `create_OCN`: performs the OCN search algorithm
  + `landscape_OCN`: calculates the elevation field generated by the OCN
      + `aggregate_OCN`: aggregates the OCN at various levels
          ...
          + `OCN_to_SSN`: transforms the OCN into a SpatialStreamNetwork object^[In `OCNet` v1.2.0, this function is disabled following the archival of the `SSN` package from CRAN (due to the retirement of `rgdal`). A new `OCN_to_SSN` function will be included in the next release of `OCNet`.]
